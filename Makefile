...
elba: obj/main.o obj/FastaIndex.o obj/FastaData.o obj/DnaSeq.o obj/SeqStore.o obj/CommGrid.o obj/MPIType.o obj/Logger.o
	@echo CXX -c -o $@ $^
...
obj/FastaData.o: src/FastaData.cpp inc/FastaData.h
